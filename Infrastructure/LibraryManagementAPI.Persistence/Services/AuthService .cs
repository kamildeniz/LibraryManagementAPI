...
using LibraryManagementAPI.Application.DTOs.Facebook;
...
namespace LibraryManagementAPI.Persistence.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(System.Net.Http.IHttpClientFactory httpClientFactory,
        ...
        public async Task<Token> FacebookLoginAsync(string authToken, int accessTokenLifeTime)
        {
            ...
            if (validation?.Data.IsValid != null)
            {
                ...
                return await CreateUserExternalAsync(user, userInfo.Email, userInfo.FirstName, userInfo.LastName, info, accessTokenLifeTime);
            }
            throw new Exception("Invalid external authentication.");
        }
        public async Task<Token> GoogleLoginAsync(string idToken, int accessTokenLifeTime)
        {
            ...
            return await CreateUserExternalAsync(user, payload.Email, payload.Name, payload.FamilyName, info, accessTokenLifeTime);
        }
