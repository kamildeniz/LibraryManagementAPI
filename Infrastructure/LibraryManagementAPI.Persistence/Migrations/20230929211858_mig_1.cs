        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowedStatus = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    BooksBorrowed = table.Column<string>(type: "text", nullable: true),
                    BookLimit = table.Column<int>(type: "integer", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "BookBookImageFile",
                columns: table => new
                {
                    BookImageFilesId = table.Column<Guid>(type: "uuid", nullable: false),
                    BooksId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBookImageFile", x => new { x.BookImageFilesId, x.BooksId });
                    table.ForeignKey(
                        name: "FK_BookBookImageFile_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookBookImageFile_Files_BookImageFilesId",
                        column: x => x.BookImageFilesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookBookImageFile_BooksId",
                table: "BookBookImageFile",
                column: "BooksId");
